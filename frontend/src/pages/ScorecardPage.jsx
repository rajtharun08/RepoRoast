...
export default function ScorecardPage() {
  ...
  if (error || !scorecard) {
    return (
      <div className="min-h-screen bg-[#060913] flex items-center justify-center p-4">
        <div className="bg-[#0b101d] border border-slate-800 rounded-3xl p-8 max-w-md w-full text-center space-y-4">
  ...
  return (
    <div className="min-h-screen bg-[#060913] text-slate-100 p-4 md:p-8 font-sans selection:bg-orange-500/30 selection:text-orange-200 print:bg-white print:text-black">
      <div className="max-w-4xl mx-auto space-y-8 py-4">
        
        {/* Top Header Bar */}
        <div className="bg-[#0b101d] border border-slate-800 rounded-3xl p-6 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-4 print:hidden">
          <div>
        ...
        {/* Main Scorecard Card */}
        <div className="bg-[#0b101d] border border-slate-800 rounded-3xl overflow-hidden shadow-2xl space-y-6 print:border-none print:shadow-none">
          ...
          <div className="px-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-[#060913] border border-slate-800/80 rounded-2xl p-6 text-center flex flex-col items-center justify-center">
            ...
            <div className="bg-[#060913] border border-slate-800/80 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
            ...
            <div className="space-y-3">
              {Object.entries({
                ...
                <div key={label} className="space-y-1.5">
                  ...
                  <div className="w-full bg-[#060913] rounded-full h-2.5 overflow-hidden border border-slate-800">
                    <div 
        ...
        <div className="flex items-center justify-between bg-[#0b101d] border border-slate-800 rounded-3xl p-6 shadow-xl print:hidden">
          <span className="text-xs text-slate-400 font-mono">Ready for another repository roast?</span>
          <Link
            to="/setup"
            className="flex items-center gap-2 bg-gradient-to-r from-orange-500 via-amber-500 to-red-500 hover:from-orange-600 text-white font-bold text-xs px-6 py-3 rounded-xl shadow-lg transition-all cursor-pointer"
          >
            <RotateCcw className="w-4 h-4" />
            <span>Start New Interview</span>
          </Link>
